...
class MainWindow(QMainWindow, mainwindow_auto.Ui_MainWindow):
    ...
    def pressedDig1(self):
        ...
        os.system("sudo mpg123 /home/pi/workspace/sound/m1.mp3")
    def pressedDig2(self):
        self.lineEdit.insert('2')
        os.system("sudo mpg123 /home/pi/workspace/sound/m2.mp3")
    def pressedDig3(self):
        self.lineEdit.insert('3')
        os.system("sudo mpg123 /home/pi/workspace/sound/m3.mp3")
    def pressedDig4(self):
        self.lineEdit.insert('4')
        os.system("sudo mpg123 /home/pi/workspace/sound/m4.mp3")
    def pressedDig5(self):
        self.lineEdit.insert('5')
        os.system("sudo mpg123 /home/pi/workspace/sound/m5.mp3")
    def pressedDig6(self):
        self.lineEdit.insert('6')
        os.system("sudo mpg123 /home/pi/workspace/sound/m6.mp3")
    def pressedDig7(self):
        self.lineEdit.insert('7')
        os.system("sudo mpg123 /home/pi/workspace/sound/m7.mp3")
    def pressedDig8(self):
        self.lineEdit.insert('8')
        os.system("sudo mpg123 /home/pi/workspace/sound/m8.mp3")
    def pressedDig9(self):
        self.lineEdit.insert('9')
        os.system("sudo mpg123 /home/pi/workspace/sound/m9.mp3")
    def pressedDig0(self):
        self.lineEdit.insert('0')
        os.system("sudo mpg123 /home/pi/workspace/sound/m0.mp3")
